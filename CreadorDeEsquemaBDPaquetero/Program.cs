...
namespace CreadorDeEsquemaBDPaquetero
{
    public class Program:ConsolaBasica
    {
        static void Main(string[] args)
        {
            ...
            crearBD_SQlite_ParaAndroid(getEsquema_BDPostgresOriginal());
            endC();
        }
        ...
        //public static EsquemaBD getEsquema_BDPostgresOriginal_ParaAndroid()
        //{
        //    int TAMAÑO_NOMBRE = 50;
        //    int TAMAÑO_TIPO_DE_MONEDA = 50;
        //    int TAMAÑO_NORMAL = 50;
        ...
        //    Pelicula.addC("Anno", TipoDeDatoSQL.INTEGER);
        //    Pelicula.addC("Origen", TAMAÑO_GRANDE);
        //    Pelicula.addC("Sinopsis", TipoDeDatoSQL.VARCHAR);
        //    Pelicula.addC("Saga", TAMAÑO_GRANDE);
        //    //Pelicula.addC("Inicial", TAMAÑO_GRANDE);
        //    Pelicula.addC("FotoPelicula", TAMAÑO_FOTO);
        //    Pelicula.addC("Definicion", TAMAÑO_GRANDE);
        ...
        //    Serie.addC("Origen");
        //    Serie.addC("Sinopsis", TipoDeDatoSQL.VARCHAR);
        //    Serie.addC("FotoSerie", TAMAÑO_FOTO);
        //    Serie.addC("Inicial", TAMAÑO_GRANDE);
        //    Serie.addC("EnCurso", TipoDeDatoSQL.BOOLEAN);
        ...
        public static void crearBD_SQlite_ParaAndroid(EsquemaBD e)
        {
            ...
            //f.NombreBDAdmin = "BDPaquetero";
            //f.DireccionBDSqlite = "BDPaquetero.sqlite";
            f.DireccionPaquete = "com.example.rene2.apppaquete.BDEntidades";
            f.sufijoModelos = "_PG";
            f.NombreClaseBDPadre = "I_BD_Admin";

            //f.idDeafult = "Id";
            //f.TipoDeConexion = TipoDeConexionBD.SQL_LITE;
            //f.crearCodigoCSharp(new DirectoryInfo(@"D:\_Cosas\pincha\Paqutero Vietnamita Frances con Katanas\Segundo trabajo\EsquemaBD_C#\BDPaquetero_EsquemaYUtilesConsola\BDPaquetero\BDManagerPeliculas"));
            //f.crearCodigoCSharp(new DirectoryInfo(@"D:\_Cosas\pincha\Paqutero_Vietnamita_Frances_con_Katanas\Proyecto_Android\CreadorDeUtilesJsonPaqutero\CreadorDeUtilesJsonPaqutero\ModelosBDPostgres"));
            f.crearCodigoAndroid(true,new DirectoryInfo(@"D:\_Cosas\pincha\Paqutero_Vietnamita_Frances_con_Katanas\Proyecto_Android\MyApplication\app\src\main\java\com\example\rene2\apppaquete\BDEntidades"));
            cwl("termino");
        }
